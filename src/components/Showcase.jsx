        ...
        <div className="flex flex-col gap-y-8">
          ...
          <div className="flex flex-wrap gap-x-10 justify-center">
            ...
            <div className="group relative">
              ...
              <img src="/images/showcase-4.png" alt="" className="group-hover:border-4 transition-all ease-in-out duration-200 border-violet-700 rounded-2xl w-[320px] h-[220px]" />
            </div>
          </div>
        </div>
      </section>
